...
//Vertices for letter B
    -0.27f, -0.19f, -0.07f,  1.0f, 1.0f, 0.0f, // 180
    -0.27f,  0.01f, -0.07f,  1.0f, 1.0f, 0.0f, // 181
    -0.17f, -0.09f, -0.07f,  1.0f, 1.0f, 0.0f, // 182
    -0.27f, -0.37f, -0.07f,  1.0f, 1.0f, 0.0f, // 183
    -0.27f, -0.17f, -0.07f,  1.0f, 1.0f, 0.0f, // 184
    -0.17f, -0.27f, -0.07f,  1.0f, 1.0f, 0.0f, // 185
    
//Vertices for letter M
    -0.15f, -0.37f, -0.07f,  1.0f, 1.0f, 0.0f, // 186
    -0.15f, -0.01f, -0.07f,  1.0f, 1.0f, 0.0f, // 187
    -0.07f, -0.37f, -0.07f,  1.0f, 1.0f, 0.0f, // 188
    -0.09f, -0.37f, -0.07f,  1.0f, 1.0f, 0.0f, // 189
    -0.01f, -0.01f, -0.07f,  1.0f, 1.0f, 0.0f, // 190
    -0.01f, -0.37f, -0.07f,  1.0f, 1.0f, 0.0f, // 191

//Vertices for A
     0.01f, -0.37f, -0.07f,  1.0f, 1.0f, 0.0f, // 192
     0.08f, -0.01f, -0.07f,  1.0f, 1.0f, 0.0f, // 193
     0.15f, -0.37f, -0.07f,  1.0f, 1.0f, 0.0f, // 194

//Vertices for J
     0.16f, -0.27f, -0.07f,  1.0f, 1.0f, 0.0f, // 195
     0.21f, -0.37f, -0.07f,  1.0f, 1.0f, 0.0f, // 196
     0.26f, -0.27f, -0.07f,  1.0f, 1.0f, 0.0f, // 197
     0.22f, -0.27f, -0.07f,  1.0f, 1.0f, 0.0f, // 198
     0.26f, -0.01f, -0.07f,  1.0f, 1.0f, 0.0f, // 199
     0.26f, -0.27f, -0.07f,  1.0f, 1.0f, 0.0f, // 200
