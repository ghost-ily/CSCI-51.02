...
float vertices[] =
{
    ...
    -0.15f,  0.35f,  0.00f,  1.0f, 1.0f, 0.0f,  //4
    -0.25f,  0.30f,  0.00f,  1.0f, 1.0f, 0.0f,  //5
    -0.15f,  0.30f,  0.00f,  1.0f, 1.0f, 0.0f,  //6
    -0.25f,  0.35f,  0.00f,  1.0f, 1.0f, 0.0f,  //7

    -0.15f,  0.45f,  0.00f,  1.0f, 1.0f, 0.0f,  //8
    -0.25f,  0.40f,  0.00f,  1.0f, 1.0f, 0.0f,  //9
    -0.15f,  0.40f,  0.00f,  1.0f, 1.0f, 0.0f,  //10
    -0.25f,  0.45f,  0.00f,  1.0f, 1.0f, 0.0f,  //11

    -0.15f,  0.55f,  0.00f,  1.0f, 1.0f, 0.0f,  //12
    -0.25f,  0.50f,  0.00f,  1.0f, 1.0f, 0.0f,  //13
    -0.15f,  0.50f,  0.00f,  1.0f, 1.0f, 0.0f,  //14
    -0.25f,  0.55f,  0.00f,  1.0f, 1.0f, 0.0f,  //15

   -0.02f, 0.25f, 0.00f,  1.0f, 1.0f, 0.0f,     //16
   -0.12f, 0.20f, 0.00f,  1.0f, 1.0f, 0.0f,     //17
   -0.02f, 0.20f, 0.00f,  1.0f, 1.0f, 0.0f,     //18
   -0.12f, 0.25f, 0.00f,  1.0f, 1.0f, 0.0f,     //19

   -0.02f, 0.35f, 0.00f,  1.0f, 1.0f, 0.0f,     //20
   -0.12f, 0.30f, 0.00f,  1.0f, 1.0f, 0.0f,     //21
   -0.02f, 0.30f, 0.00f,  1.0f, 1.0f, 0.0f,     //22
   -0.12f, 0.35f, 0.00f,  1.0f, 1.0f, 0.0f,     //23

   -0.02f, 0.45f, 0.00f,  1.0f, 1.0f, 0.0f,     //24
   -0.12f, 0.40f, 0.00f,  1.0f, 1.0f, 0.0f,     //25
   -0.02f, 0.40f, 0.00f,  1.0f, 1.0f, 0.0f,     //26
   -0.12f, 0.45f, 0.00f,  1.0f, 1.0f, 0.0f,     //27

   -0.02f, 0.55f, 0.00f,  1.0f, 1.0f, 0.0f,     //28
   -0.12f, 0.50f, 0.00f,  1.0f, 1.0f, 0.0f,     //29
   -0.02f, 0.50f, 0.00f,  1.0f, 1.0f, 0.0f,     //30
   -0.12f, 0.55f, 0.00f,  1.0f, 1.0f, 0.0f,     //31

   -0.02f, 0.65f, 0.00f,  1.0f, 1.0f, 0.0f,     //32
   -0.12f, 0.60f, 0.00f,  1.0f, 1.0f, 0.0f,     //33
   -0.02f, 0.60f, 0.00f,  1.0f, 1.0f, 0.0f,     //34
   -0.12f, 0.65f, 0.00f,  1.0f, 1.0f, 0.0f,     //35
   
   -0.02f, 0.75f, 0.00f,  1.0f, 1.0f, 0.0f,     //36
   -0.12f, 0.70f, 0.00f,  1.0f, 1.0f, 0.0f,     //37
   -0.02f, 0.70f, 0.00f,  1.0f, 1.0f, 0.0f,     //38
   -0.12f, 0.75f, 0.00f,  1.0f, 1.0f, 0.0f,     //39
};
