...
{   
    ...
    //top triangles
     ...
     0.11f,  0.37f, 0.00f,  1.0f, 1.0f, 1.0f,  0.61f, 0.72f,
    ...
    -0.11f, -0.37f, 0.00f,  1.0f, 1.0f, 1.0f,  0.36f, 0.28f,

     0.00f, -0.00f, 0.00f,  1.0f, 1.0f, 1.0f,  0.50f, 0.50f,
     0.00f, -0.65f, 0.00f,  1.0f, 1.0f, 1.0f,  0.50f, 0.0f,
     0.26f, -0.65f, 0.00f,  1.0f, 1.0f, 1.0f,  0.21f, 1.0f,
    ...
    //right triangles
     ...
     0.37f,  0.00f, 0.00f,  1.0f, 1.0f, 1.0f,  0.10f, 0.50f,
