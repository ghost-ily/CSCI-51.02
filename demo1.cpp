...
float vertices[] =
{
    // position (x, y, z)      color (r, g, b)       texture (s, t)  normal (nx, ny, nz)
    //FRONT FACE
    0.000f,  0.000f, -1.000f,  1.00f, 1.00f, 1.00f,  0.50f/2, 0.50f, 0.0f, 0.0f, -1.0f,
    0.500f,  0.000f, -1.000f,  1.00f, 1.00f, 1.00f,  1.00f/2, 0.50f, 0.0f, 0.0f, -1.0f,
    0.383f,  0.321f, -1.000f,  1.00f, 1.00f, 1.00f,  0.88f/2, 0.82f, 0.0f, 0.0f, -1.0f,

    0.000f,  0.000f, -1.000f,  1.00f, 1.00f, 1.00f,  0.50f/2, 0.50f, 0.0f, 0.0f, -1.0f,
    0.383f,  0.321f, -1.000f,  1.00f, 1.00f, 1.00f,  0.88f/2, 0.82f, 0.0f, 0.0f, -1.0f,
    0.087f,  0.492f, -1.000f,  1.00f, 1.00f, 1.00f,  0.58f/2, 1.00f, 0.0f, 0.0f, -1.0f,

    0.000f,  0.000f, -1.000f,  1.00f, 1.00f, 1.00f,  0.50f/2, 0.50f, 0.0f, 0.0f, -1.0f,
    0.087f,  0.492f, -1.000f,  1.00f, 1.00f, 1.00f,  0.58f/2, 1.00f, 0.0f, 0.0f, -1.0f,
   -0.250f,  0.433f, -1.000f,  1.00f, 1.00f, 1.00f,  0.25f/2, 0.93f, 0.0f, 0.0f, -1.0f,

    0.000f,  0.000f, -1.000f,  1.00f, 1.00f, 1.00f,  0.50f/2, 0.50f, 0.0f, 0.0f, -1.0f,
   -0.250f,  0.433f, -1.000f,  1.00f, 1.00f, 1.00f,  0.25f/2, 0.93f, 0.0f, 0.0f, -1.0f,
   -0.470f,  0.171f, -1.000f,  1.00f, 1.00f, 1.00f,  0.03f/2, 0.67f, 0.0f, 0.0f, -1.0f,

    0.000f,  0.000f, -1.000f,  1.00f, 1.00f, 1.00f,  0.50f/2, 0.50f, 0.0f, 0.0f, -1.0f,
   -0.470f,  0.171f, -1.000f,  1.00f, 1.00f, 1.00f,  0.03f/2, 0.67f, 0.0f, 0.0f, -1.0f,
   -0.470f, -0.171f, -1.000f,  1.00f, 1.00f, 1.00f,  0.03f/2, 0.33f, 0.0f, 0.0f, -1.0f,

    0.000f,  0.000f, -1.000f,  1.00f, 1.00f, 1.00f,  0.50f/2, 0.50f, 0.0f, 0.0f, -1.0f,
   -0.470f, -0.171f, -1.000f,  1.00f, 1.00f, 1.00f,  0.03f/2, 0.33f, 0.0f, 0.0f, -1.0f,
   -0.250f, -0.433f, -1.000f,  1.00f, 1.00f, 1.00f,  0.25f/2, 0.07f, 0.0f, 0.0f, -1.0f,

    0.000f,  0.000f, -1.000f,  1.00f, 1.00f, 1.00f,  0.50f/2, 0.50f, 0.0f, 0.0f, -1.0f,
   -0.250f, -0.433f, -1.000f,  1.00f, 1.00f, 1.00f,  0.25f/2, 0.07f, 0.0f, 0.0f, -1.0f,
    0.087f, -0.492f, -1.000f,  1.00f, 1.00f, 1.00f,  0.58f/2, 0.00f, 0.0f, 0.0f, -1.0f,

    0.000f,  0.000f, -1.000f,  1.00f, 1.00f, 1.00f,  0.50f/2, 0.50f, 0.0f, 0.0f, -1.0f,
    0.087f, -0.492f, -1.000f,  1.00f, 1.00f, 1.00f,  0.58f/2, 0.00f, 0.0f, 0.0f, -1.0f,
    0.383f, -0.321f, -1.000f,  1.00f, 1.00f, 1.00f,  0.88f/2, 0.18f, 0.0f, 0.0f, -1.0f,
    ...
    //BACK FACE
    0.000f,  0.000f, -0.800f,  1.00f, 1.00f, 1.00f,  0.75f, 0.50f, 0.0f, 0.0f, 1.0f,
    0.383f,  0.321f, -0.800f,  1.00f, 1.00f, 1.00f,  0.94f, 0.82f, 0.0f, 0.0f, 1.0f,
    0.500f,  0.000f, -0.800f,  1.00f, 1.00f, 1.00f,  1.00f, 0.50f, 0.0f, 0.0f, 1.0f,

    0.000f,  0.000f, -0.800f,  1.00f, 1.00f, 1.00f,  0.75f, 0.50f, 0.0f, 0.0f, 1.0f,
    0.087f,  0.492f, -0.800f,  1.00f, 1.00f, 1.00f,  0.79f, 0.99f, 0.0f, 0.0f, 1.0f,
    0.383f,  0.321f, -0.800f,  1.00f, 1.00f, 1.00f,  0.94f, 0.82f, 0.0f, 0.0f, 1.0f,

    0.000f,  0.000f, -0.800f,  1.00f, 1.00f, 1.00f,  0.75f, 0.50f, 0.0f, 0.0f, 1.0f,
   -0.250f,  0.433f, -0.800f,  1.00f, 1.00f, 1.00f,  0.625f, 0.93f, 0.0f, 0.0f, 1.0f,
    0.087f,  0.492f, -0.800f,  1.00f, 1.00f, 1.00f,  0.79f, 0.99f, 0.0f, 0.0f, 1.0f,

    0.000f,  0.000f, -0.800f,  1.00f, 1.00f, 1.00f,  0.75f, 0.50f, 0.0f, 0.0f, 1.0f,
   -0.470f,  0.171f, -0.800f,  1.00f, 1.00f, 1.00f,  0.51f, 0.67f, 0.0f, 0.0f, 1.0f,
   -0.250f,  0.433f, -0.800f,  1.00f, 1.00f, 1.00f,  0.625f, 0.93f, 0.0f, 0.0f, 1.0f,

    0.000f,  0.000f, -0.800f,  1.00f, 1.00f, 1.00f,  0.75f, 0.50f, 0.0f, 0.0f, 1.0f,
   -0.470f, -0.171f, -0.800f,  1.00f, 1.00f, 1.00f,  0.51f, 0.33f, 0.0f, 0.0f, 1.0f,
   -0.470f,  0.171f, -0.800f,  1.00f, 1.00f, 1.00f,  0.51f, 0.67f, 0.0f, 0.0f, 1.0f,

    0.000f,  0.000f, -0.800f,  1.00f, 1.00f, 1.00f,  0.75f, 0.50f, 0.0f, 0.0f, 1.0f,
   -0.250f, -0.433f, -0.800f,  1.00f, 1.00f, 1.00f,  0.625f, 0.07f, 0.0f, 0.0f, 1.0f,
   -0.470f, -0.171f, -0.800f,  1.00f, 1.00f, 1.00f,  0.51f, 0.33f, 0.0f, 0.0f, 1.0f,

    0.000f,  0.000f, -0.800f,  1.00f, 1.00f, 1.00f,  0.75f, 0.50f, 0.0f, 0.0f, 1.0f,
    0.087f, -0.492f, -0.800f,  1.00f, 1.00f, 1.00f,  0.79f, 0.01f, 0.0f, 0.0f, 1.0f,
   -0.250f, -0.433f, -0.800f,  1.00f, 1.00f, 1.00f,  0.625f, 0.07f, 0.0f, 0.0f, 1.0f,

    0.000f,  0.000f, -0.800f,  1.00f, 1.00f, 1.00f,  0.75f, 0.50f, 0.0f, 0.0f, 1.0f,
    0.383f, -0.321f, -0.800f,  1.00f, 1.00f, 1.00f,  0.94f, 0.18f, 0.0f, 0.0f, 1.0f,
    0.087f, -0.492f, -0.800f,  1.00f, 1.00f, 1.00f,  0.79f, 0.01f, 0.0f, 0.0f, 1.0f,
    ...
    // SIDE FACES
    // Edge 1
    0.500f, 0.000f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.85f, 0.09f, 0.00f,
    0.383f, 0.321f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.85f, 0.09f, 0.00f,
    0.383f, 0.321f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.85f, 0.09f, 0.00f,

    0.500f, 0.000f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.85f, 0.09f, 0.00f,
    0.383f, 0.321f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.85f, 0.09f, 0.00f,
    0.500f, 0.000f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.85f, 0.09f, 0.00f,

    // Edge 2
    0.383f, 0.321f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.5f, 0.09f, 0.0f,
    0.087f, 0.492f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.5f, 0.09f, 0.0f,
    0.087f, 0.492f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.5f, 0.09f, 0.0f,

    0.383f, 0.321f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.5f, 0.09f, 0.0f,
    0.087f, 0.492f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.5f, 0.09f, 0.0f,
    0.383f, 0.321f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, 0.5f, 0.09f, 0.0f,

    // Edge 3
    0.087f, 0.492f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,
   -0.250f, 0.433f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,
   -0.250f, 0.433f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,

    0.087f, 0.492f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,
   -0.250f, 0.433f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,
    0.087f, 0.492f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,

    // Edge 4
   -0.250f, 0.433f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.77f, 0.09f, 0.00f,
   -0.470f, 0.171f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.77f, 0.09f, 0.00f,
   -0.470f, 0.171f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.77f, 0.09f, 0.00f,

   -0.250f, 0.433f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.77f, 0.09f, 0.00f,
   -0.470f, 0.171f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.77f, 0.09f, 0.00f,
   -0.250f, 0.433f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.77f, 0.09f, 0.00f,

    // Edge 5
   -0.470f,  0.171f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -1.00f, 0.09f, 0.00f,
   -0.470f, -0.171f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -1.00f, 0.09f, 0.00f,
   -0.470f, -0.171f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -1.00f, 0.09f, 0.00f,
   ...
   -0.250f, -0.433f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,
    ...
    // Edge 8
    0.087f, -0.492f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,
    0.383f, -0.321f, -1.000f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,
    0.383f, -0.321f, -0.800f, 0.50f, 0.50f, 0.50f,  0.50f, 0.50f, -0.17f, 0.09f, 0.00f,
...
bool setup()
{
    ...
    // textures for coin
    texture = gdevLoadTexture("coin.jpg", GL_CLAMP_TO_EDGE, true, true);
    if (! texture)
        return false;

    normalTexture = gdevLoadTexture("coin_normal.jpg", GL_CLAMP_TO_EDGE, true, true);
    if (! normalTexture)
        return false;
    return true;
}
...
void render()
{
    ...
    glDrawArrays(GL_TRIANGLES, 0, sizeof(vertices3) / (6 * sizeof(float)));
}
